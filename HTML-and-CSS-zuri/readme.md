# zuri intenship traing 2022

## [A simple website with registration form and login form](/-HTML-and-CSS-zuri/)
...
![SAMUEL EFFIONG](/-HTML-and-CSS-zuri/img/samuel%20effiong%20%20(2).jpeg)

Contact: let the user tell u his/ her problem

![samuel](/-HTML-and-CSS-zuri/img/samuel%20effiong%20%20(3).jpeg)

Registration page: Create a big, fancy Contact Me button at the bottom of the home page that will load the contact page when clicked on. The contact me page should have a form with the below fields. The form should have a submit button and basic HTML validation.
Name
Email
Message
...
password
Confirm password
![SAMUEL EFFIONG](/-HTML-and-CSS-zuri/img/samuel%20effiong%20%20(4).jpeg)
...
![SAMUEL EFFIONG](/-HTML-and-CSS-zuri/img/samuel%20effiong%20%20(1).jpeg)
